 ...
 */
final class Version20210804081925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT NOT NULL, method_id INT NOT NULL, amount NUMERIC(10, 2) NOT NULL, time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6D28840D19883967 ON payment (method_id)');
        $this->addSql('CREATE TABLE payment_method (id INT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D19883967 FOREIGN KEY (method_id) REFERENCES payment_method (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
